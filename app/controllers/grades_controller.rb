class GradesController < ApplicationController
  ...
  def view_my_scores
    ...
    if @assignment.is_selfreview_enabled?
      ...
      composite_final_score = calculate_self_score_weighted_score(actual_score, avg_self_review_score, impact_factor)
  ...
  # function to calculate the score incorporating the new self score bonus
  # self _score ranges from 0 to 1, this will go nearer to 1 as avg_self_review_score goes nearer to actual_score
  def calculate_self_score(actual_score = 0, avg_self_review_score = 0)
    1 - ((actual_score - avg_self_review_score).abs/100)
  end

  # Composite_final_score will add the bonus marks to actual_score. Bonus marks is generated by multiplying impact_factor with self_score
  def calculate_self_score_weighted_score(actual_score = 0, avg_self_review_score = 0, impact_factor = 10)
    self_score = calculate_self_score(actual_score, avg_self_review_score)
    actual_score + (impact_factor * self_score)
  end
