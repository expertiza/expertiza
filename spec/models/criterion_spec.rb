describe 'criterion' do
  ...
  let(:criterion) { Criterion.new id: 1, type: 'Criterion', seq: 1.0, txt: 'test txt', weight: 1, itemnaire: itemnaire }
  ...
  describe '#edit' do
    it 'returns the html ' do
      ...
      expect(html).to eq('<tr><td align="center"><a rel="nofollow" data-method="delete" href="/items/1">Remove</a></td><td><input size="6" value="1.0" name="item[1][seq]" id="item_1_seq" type="text"></td><td><textarea cols="50" rows="1" name="item[1][txt]" id="item_1_txt" placeholder="Edit item content here">test txt</textarea></td><td><input size="10" disabled="disabled" value="Criterion" name="item[1][type]" id="item_1_type" type="text"></td><td><input size="2" value="1" name="item[1][weight]" id="item_1_weight" type="text"></td><td>text area size <input size="3" value="" name="item[1][size]" id="item_1_size" type="text"></td><td> min_label <input size="12" value="" name="item[1][min_label]" id="item_1_min_label" type="text">  max_label <input size="10" value="" name="item[1][max_label]" id="item_1_max_label" type="text"></td></tr>')
    end
  end

  describe '#view_item_text' do
    it 'returns the html ' do
      html = criterion.view_item_text.to_s
  ...
  describe '#complete' do
    ...
    it 'returns the html with no comments answer and answer.answer outside itemnaire min and max and dropdown' do
    ...
    it 'returns the html with comments answer and answer.answer between itemnaire min and max and dropdown' do
    ...
    it 'returns the html with no comments answer and answer.answer outside itemnaire min and max and scale' do
    ...
    it 'returns the html with comments answer and answer.answer between itemnaire min and max and scale' do
  ...
  describe '#dropdown_criterion_item' do
    it 'returns the html without answer' do
      html = criterion.dropdown_criterion_item(0, nil, 0, 5).to_s
    ...
    it 'returns the html with no comments answer and answer.answer outside itemnaire min and max' do
      html = criterion.dropdown_criterion_item(0, answer_no_comments, 0, 5).to_s
      expect(html).to eq("<div><select id=\"responses_0_score\" name=\"responses[0][score]\" class=\"review-rating\" data-current-rating =8><option value = ''>--</option><option value=0>0</option><option value=1>1</option><option value=2>2</option><option value=3>3</option><option value=4>4</option><option value=5>5</option></select></div><br><br><textarea id=\"responses_0_comments\" name=\"responses[0][comment]\" class=\"tinymce\"></textarea></td>")
    end

    it 'returns the html with comments in answer and answer.answer between itemnaire min and max' do
      html = criterion.dropdown_criterion_item(0, answer_comments, 0, 5).to_s
  ...
  describe '#scale_criterion_item' do
    it 'returns the html without answer' do
      html = criterion.scale_criterion_item(0, nil, 0, 5).to_s
    ...
    it 'returns the html with no comments answer and answer.answer outside itemnaire min and max' do
      html = criterion.scale_criterion_item(0, answer_no_comments, 0, 5).to_s
    ...
    it 'returns the html with comments answer and answer.answer between itemnaire min and max' do
      html = criterion.scale_criterion_item(0, answer_comments, 0, 5).to_s
  ...
  describe '#view_completed_item' do
    it 'returns the html ' do
      html = criterion.view_completed_item(0, answer_no_comments, 5).to_s
  ...
  describe '#advices_criterion_item' do
    it 'returns the html' do
      html = criterion.advices_criterion_item(1, []).to_s
