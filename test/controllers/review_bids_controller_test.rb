...
class ReviewBidsControllerTest < ActionController::TestCase
  ...
  test "should create review_bid" do
    assert_difference('ReviewBid.count') do
      post :create, review_bid: { priority: @review_bid.priority, student_id: @review_bid.student_id, topic_id: @review_bid.topic_id }
    end
  ...
  test "should update review_bid" do
    patch :update, id: @review_bid, review_bid: { priority: @review_bid.priority, student_id: @review_bid.student_id, topic_id: @review_bid.topic_id }
    assert_redirected_to review_bid_path(assigns(:review_bid))
  end
