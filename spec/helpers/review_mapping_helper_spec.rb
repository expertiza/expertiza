...
describe ReviewMappingHelper, type: :helper do
  ...
  describe 'awarded_review_metrics?' do
    before(:each) do
      create(:deadline_right, name: 'No')
      create(:deadline_right, name: 'Late')
      create(:deadline_right, name: 'OK')
      ...
      awarded_review_metrics?(@reviewer.id, @reviewee.id)
    end
  ...
  # moved test calculate_key_chart_information tests to the review_mapping_chart_helper_spec file
