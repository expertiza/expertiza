class LotteryController < ApplicationController
  ...
  def create_new_teams_for_bidding_response(teams, assignment, users_bidding_info)
    teams.each do |user_ids|
      new_team = assignment.auto_assign_mentor ? MentoredTeam.create_team_and_node(assignment.id, user_ids) : AssignmentTeam.create_team_and_node(assignment.id, user_ids)
