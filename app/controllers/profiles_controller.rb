class ProfilesController < ApplicationController
  ...
  def update
    ...
    if @user.update_attributes(params[:user])
      ExpertizaLogger.info LoggerMessage.new(controller_name, @user.name, "Your profiles was successfully updated.", request)
      flash[:success] = 'Your profiles was successfully updated.'
    else
      ExpertizaLogger.error LoggerMessage.new(controller_name, @user.name, "An error occurred and your profiles could not updated.", request)
      flash[:error] = 'An error occurred and your profiles could not updated.'
    end
