...
SiteController.create(:name => 'signup_sheet', :builtin => false, :permission_id => Permission.find_by_name('administer assignments').id)
...
ControllerAction.create(:site_controller_id => SiteController.find_by_name('signup_sheet').id, :name => 'list', :permission_id => Permission.find_by_name('do assignments').id, :url_to_use => '')
ControllerAction.create(:site_controller_id => SiteController.find_by_name('signup_sheet').id, :name => 'signup', :permission_id => Permission.find_by_name('do assignments').id, :url_to_use => '')
ControllerAction.create(:site_controller_id => SiteController.find_by_name('signup_sheet').id, :name => 'delete_signup', :permission_id => Permission.find_by_name('do assignments').id, :url_to_use => '')
