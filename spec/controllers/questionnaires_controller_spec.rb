describe QuestionnairesController do
  ...
  describe '#update' do
    before(:each) do
      ...
      @questionnaire3 = double('Questionnaire', id: 3)
      allow(Questionnaire).to receive(:find).with('3').and_return(@questionnaire3)
      @questionnaire4 = double('Questionnaire', id: 4)
      ...
      @assignment_questionnaire1 = double('AssignmentQuestionnaire', id: 1, assignment_id: 1, questionnaire_id: 3, used_in_round: 1)
      allow(AssignmentQuestionnaire).to receive(:find).with('1').and_return(@assignment_questionnaire1)
      @assignment_questionnaire2 = double('AssignmentQuestionnaire', id: 2, assignment_id: 1, questionnaire_id: 4, used_in_round: 2)
