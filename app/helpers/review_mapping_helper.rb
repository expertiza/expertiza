module ReviewMappingHelper
  ...
  # Populates reviewer volumes based on review comments
  def populate_reviewer_comment_volumes
    @reviewers.each do |r|
  ...
  def sort_reviewer_by_review_volume_desc
    populate_reviewer_comment_volumes
  ...
  def initialize_chart_elements(reviewer)
    ...
    # Display average volume for all reviewers per round
  ...
  # Lists the review submissions for a participant and review team
  ...
  # Review strategy for a single student
  ...
  # Review strategy for a team of students
