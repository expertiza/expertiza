jQuery(document).ready(function() {
  ...
  function showIntelligentAssignmentDialog() {
    ...
    var App = React.createClass({
        render: function() {
            return (
        <div><button type="button" className="btn btn-primary btn-lg" data-toggle="modal" data-target="#myModal">Actions
            </button>
            ...
            <h4 className="modal-title" id="myModalLabel">Actions</h4>
            </div>
