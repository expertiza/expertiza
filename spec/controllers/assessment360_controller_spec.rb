describe Assessment360Controller do
  ...
  describe '#all_students_all_reviews_all_grades' do
    context 'when course does not have participants' do
      before(:each) do
        request.env['HTTP_REFERER'] = 'http://example.com'
        get "all_students_all_reviews_all_grades"
      end
  ...
  describe '#all_students_all_reviews' do
    ...
    enddescribe '#all_students_all_reviews' do
    context 'when course does not have participants' do
      before(:each) do
        request.env['HTTP_REFERER'] = 'http://example.com'
        get "all_students_all_reviews"
      ...
      it 'has participants, next assignment participant exists, but there are no reviews' do
        ...
        allow(course_participant).to recedescribe '#all_students_all_reviews' do
        context 'when course does not have participants' do
          before(:each) do
            request.env['HTTP_REFERER'] = 'http://example.com'
            get "all_students_all_reviews"
          ...
          it 'redirects to back' do
            expect(response).to redirect_to(:back)
          endive(:teammate_reviews).and_return(empty_teammate_review)
      ...
      it 'has participants, next assigdescribe '#all_students_all_reviews' do
      context 'when course does not have participants' do
        before(:each) do
          request.env['HTTP_REFERER'] = 'http://example.com'
          get "all_students_all_reviews"
        ...
        it 'redirects to back' do
          expect(response).to redirect_to(:back)
        endeceive(:teammate_reviews).and_return(teammate_review)
