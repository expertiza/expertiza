...
describe SentenceState do
  ...
  it "Identify State 14 ambiguous" do
  ...
  it "Identify State suggestive 15" do
  ...
  it "Identify State suggestive 16" do
  ...
  it "Identify State suggestive 17" do
  ...
  it "Identify State negated 18" do
