...
describe "MetareviewResponseMap" do
 ...
 describe "validations" do
    before(:each) do
      @metareview_responsemap = build(:metareviewresponsemap)
    end
 
    it "metareview_responsemap is valid" do
      expect(@metareview_responsemap).to be_valid
    end
  end
...
describe "#type" do
    it "checks if type is assignment participant" do
      @metareview_responsemap = build(:metareviewresponsemap)
      expect(@metareview_responsemap.type).to eq("MetareviewResponseMap")
    end
  end
