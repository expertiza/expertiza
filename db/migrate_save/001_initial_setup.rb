class InitialSetup < ActiveRecord::Migration[4.2]
  def self.up
    create_table 'markup_styles', id: :integer, auto_increment: true, force: false do |t|
      t.column 'name', :string, default: '', null: false
    end

    create_table 'permissions', id: :integer, auto_increment: true, force: false do |t|
      t.column 'name', :string, default: '', null: false
    end

    create_table 'site_controllers', id: :integer, auto_increment: true, force: false do |t|
      t.column 'name', :string, default: '', null: false
    ...
    create_table 'content_pages', id: :integer, auto_increment: true, id: :integer, auto_increment: true, force: false do |t|
    ...
    create_table 'controller_actions', id: :integer, auto_increment: true, force: false do |t|
    ...
    create_table 'menu_items', id: :integer, auto_increment: true, force: false do |t|
    ...
    create_table 'roles', id: :integer, auto_increment: true, force: false do |t|
      t.column 'name', :string, default: '', null: false
      t.column 'parent_id', :integer
    ...
    create_table 'roles_permissions', id: :integer, auto_increment: true, force: false do |t|
    ...
    create_table 'system_settings', id: :integer, auto_increment: true, force: false do |t|
    ...
    create_table 'users', id: :integer, auto_increment: true, force: false do |t|
      t.column 'name', :string, default: '', null: false
