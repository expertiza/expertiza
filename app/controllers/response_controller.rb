...
class ResponseController < ApplicationController
  ...
  def edit
    ...
    if (@assignment.instructor_id == User.find_by_name("admin1").id) && @title == "Review"
  ...
  def new
    ...
    # Check whether this is Jen's assgt. & if so, use her rubric
    ############DOUBT##################
    if (@assignment.instructor_id == User.find_by_name("payyapp").id) && @title == "Review"
      puts "~~~~~~~~~~~~~~~~~~~In outer If~~~~~~~~~~~~~~~~~~~"
      if @assignment.id < 469
  ...
  def get_content    
    ...
    puts "~~~~~~~~~~~~~~~~~~returning from get_content~~~~~~~~~~~"
  end
