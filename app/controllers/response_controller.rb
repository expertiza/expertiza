class ResponseController < ApplicationController
  ...
  def saving   
    ...
    @map.save
    if(@map.assignment.id == 561 or @map.assignment.id == 559 or @map.assignment.id == 562) #Making the automated metareview feature available for one 'ethical analysis 6' assignment only.
