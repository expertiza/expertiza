          ...
          if (this.props.is_available) {
            moreContent.push(
              <span>
                ...
                <a title="Assign survey" href={"/survey_deployment/new?id="+(parseInt(this.props.id)/2).toString()+"&type=Course"}>
          ...
          if (this.props.is_available) {
            ...
            moreContent.push(
              <span>
                ...
                <a title="Assign survey" href={"/survey_deployment/new?id="+(parseInt(this.props.id)/2).toString()+"&type=Assignment"}>
                  <img src="/assets/tree_view/assign-survey-24.png" />
                </a>
              </span>
            )
