...
function addElement() {
    ...
    var dropIndex = document.getElementById('teamselect').selectedIndex;
    var dropValue = document.getElementById('teamselect')[dropIndex].value;
    ...
    for (i = 1; i < limit; i++) {
        ...
        if (dropValue == "true") {
            ni.innerHTML = ni.innerHTML +
                ...
                '<TD ALIGN=CENTER WIDTH=10%><input type="text" id="additional_submit_deadline_' + j + '_due_at" name ="additional_submit_deadline[' + j + '][due_at]"/></TD>' +
                ...
                '<TD ALIGN=CENTER WIDTH=10%><select id="additional_submit_deadline_' + j + '_metareview_allowed_id" name ="additional_submit_deadline[' + j + '][metareview_allowed_id]">' +
                '<option value=2>Late</option><option value=1 SELECTED>No</option><option value=3>OK</option>' +
                '</select></TD>' +

                '<TD ALIGN=CENTER WIDTH=10%><select id="additional_submit_deadline_' + j + '_signup_allowed_id" name ="additional_submit_deadline[' + j + '][signup_allowed_id]">' +
                '<option value=2>Late</option><option value=1 SELECTED>No</option><option value=3>OK</option>' +
                '</select></TD>' +

                '<TD ALIGN=CENTER WIDTH=10%><select id="additional_submit_deadline_' + j + '_drop_allowed_id" name ="additional_submit_deadline[' + j + '][drop_allowed_id]">' +
                '<option value=2>Late</option><option value=1 SELECTED>No</option><option value=3>OK</option>' +
                '</select></TD>' +

                '<TD ALIGN=CENTER WIDTH=10%><select id="additional_submit_deadline_' + j + '_teammate_review_allowed_id" name ="additional_submit_deadline[' + j + '][teammate_review_allowed_id]">' +
                '<option value=2>Late</option><option value=1 SELECTED>No</option><option value=3>OK</option>' +
                '</select></TD>' +

                '<TD ALIGN=CENTER WIDTH=10%><select id="additional_submit_deadline_' + j + '_survey_response_allowed_id" name ="additional_submit_deadline[' + j + '][survey_response_allowed_id]">' +
                '<option value=2>Late</option><option value=1 SELECTED>No</option><option value=3>OK</option>' +
                '</select></TD>' +
                ...
                '<TR><TD ALIGN=LEFT WIDTH=10%></TD>' + '<TD ALIGN=CENTER WIDTH=20%><img src="/images/cal.gif" onClick=\"NewCal(\'additional_submit_deadline_' + j + '_due_at\',\'YYYYMMDD\',true,24); return false;"></TD></TR>' +

                '<TR><TD ALIGN=LEFT WIDTH=10%>' + rereview_var + '</TD>' +
                ...
                '<TD ALIGN=CENTER WIDTH=10%><input type="text" id="additional_review_deadline_' + j + '_due_at" name ="additional_review_deadline[' + j + '][due_at]"></TD>' +
