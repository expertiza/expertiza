...
ActiveRecord::Schema.define(version: 20221129040129) do
  ...
  create_table "teams_participants", id: :integer, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1" do |t|
    ...
    t.index ["participants_id"], name: "index_teams_participants_on_participants_id"
  ...
  create_table "waitlist_teams", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.integer "team_id"
    t.integer "topic_id"
    t.datetime "created_at"
