...
Scenario: Edit a permission
	...
	And I open the permissions management link
	When I create a new permission named "test_permission"
	When I click on "test_permission"
	And I click on "Edit"
...
Scenario: Delete a permission
	Given I am logged in as admin
	When I open the permissions management link
...
Scenario: Add permission to role
	Given I am logged in as admin
		And a permission "test_permission" exists
