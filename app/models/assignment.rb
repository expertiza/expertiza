...
class Assignment < ActiveRecord::Base
  ...
  def valid_num_review
    ...
    elsif self.num_metareviews_required.nil? or self.num_metareviews_allowed.nil?
      return
    elsif self.num_metareviews_allowed != -1 && self.num_metareviews_allowed < self.num_metareviews_required
  ...
  # otherwise, return 0. (Metareviews do not have rounds.)
