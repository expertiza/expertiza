...
10. Refactor get_assessments_for method in response_map.rb and lead to more than 90\% off the current waiting time.
...
1. Refactor get_assessments_for method in response_map.rb and lead to more than 90\% off the current waiting time.
