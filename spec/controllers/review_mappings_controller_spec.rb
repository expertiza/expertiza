...
describe ReviewMappingsController do
  ...
  describe '#add_calibration' do
    context 'when both participant and review_response_map have already existed' do
      it 'does not need to create new objects and redirects to responses#new maps' do
        ...
        expect(response).to redirect_to '/responses/new?assignment_id=1&id=1&return=assignment_edit'
      end
    end
  ...
  describe '#add_reviewer and #get_reviewer' do
    ...
    context 'when team_user does not exist' do
      it 'shows an error message and redirects to review_mappings#list_mappings page' do
    ...
    context 'when team_user exists and get_reviewer method returns a reviewer' do
      it 'creates a whole bunch of objects and redirects to review_mappings#list_mappings page' do
        ...
        post :add_reviewer, @params
        expect(response).to redirect_to '/review_mappings/list_mappings?id=1&msg='
      end
    end
  end
  ...
  describe '#assign_reviewer_dynamically' do
    ...
    context 'when assignment has topics and no topic is selected by reviewer' do
      it 'shows an error message and redirects to student_reviews#list page' do
        ...
        expect(response).to redirect_to '/student_reviews/list?id=1'
      end
    end

    context 'when assignment has topics and a topic is selected by reviewer' do
      it 'assigns reviewer dynamically and redirects to student_reviews#list page' do
        allow(assignment).to receive(:topics?).and_return(true)
    ...
    context 'when assignment does not have topics' do
      it 'runs another algorithms and redirects to student_reviews#list page' do
  ...
  describe '#assign_quiz_dynamically' do
    ...
    context 'when corresponding responses map exists' do
    ...
    context 'when corresponding responses map does not exist' do
  ...
  describe '#add_metareviewer' do
    ...
    it 'redirects to review_mappings#list_mappings page' do
      user = double('User', id: 1, name: 'no one')
      allow(User).to receive(:from_params).with(any_args).and_return(user)
      # allow_any_instance_of(ReviewMappingsController).to receive(:url_for).with(action: 'add_user_to_assignment', id: 1, user_id: 1).and_return('')
      allow_any_instance_of(ReviewMappingsController).to receive(:get_reviewer)
        .with(user, assignment, 'http://test.host/review_mappings/add_user_to_assignment?id=1&user_id=1')
  ...
  describe '#assign_metareviewer_dynamically' do
    it 'redirects to student_reviews#list page' do
  ...
  describe '#delete_outstanding_reviewers' do
    ...
    context 'when review responses map has corresponding responses' do
      it 'shows a flash error and redirects to review_mappings#list_mappings page' do
    ...
    context 'when review responses map does not have corresponding responses' do
      it 'shows a flash success and redirects to review_mappings#list_mappings page' do
  ...
  describe '#delete_all_metareviewers' do
    ...
    context 'when failed times are bigger than 0' do
      it 'shows an error flash message and redirects to review_mappings#list_mappings page' do
        ...
        expect(flash[:error]).to eq("A delete action failed:<br/>1 metareviews exist for these mappings. "\
          "Delete these mappings anyway?&nbsp;<a href='http://test.host/review_mappings/delete_all_metareviewers?force=1&id=1'>Yes</a>&nbsp;|&nbsp;"\
          "<a href='http://test.host/review_mappings/delete_all_metareviewers?id=1'>No</a><br/>")
        expect(response).to redirect_to('/review_mappings/list_mappings?id=1')
      end
    end

    context 'when failed time is equal to 0' do
      it 'shows a note flash message and redirects to review_mappings#list_mappings page' do
        @metareview_response_maps.each do |metareview_response_map|
  ...
  describe '#unsubmit_review' do
    ...
    context 'when attributes of responses are updated successfully' do
    ...
    context 'when attributes of responses are not updated successfully' do
  ...
  describe '#delete_reviewer' do
    ...
    context 'when corresponding responses does not exist to current review responses map' do
    ...
    context 'when corresponding responses exists to current review responses map' do
  ...
  describe '#delete_metareviewer' do
    ...
    context 'when metareview_response_map can be deleted successfully' do
      it 'show a note flash message and redirects to review_mappings#list_mappings page' do
    ...
    context 'when metareview_response_map cannot be deleted successfully' do
      it 'show a note flash message and redirects to review_mappings#list_mappings page' do
        ...
        params = {id: 1}
        post :delete_metareviewer, params
        expect(flash[:error]).to eq("A delete action failed:<br/>Boom<a href='/review_mappings/delete_metareview/1'>Delete this mapping anyway>?")
        expect(response).to redirect_to('/review_mappings/list_mappings?id=1')
      end
    end
  end
  ...
  describe '#delete_metareview' do
    it 'redirects to review_mappings#list_mappings page after deletion' do
      allow(MetareviewResponseMap).to receive(:find).with('1').and_return(metareview_response_map)
      allow(metareview_response_map).to receive(:delete).and_return(true)
      params = {id: 1}
  ...
  describe '#list_mappings' do
    it 'renders review_mappings#list_mappings page' do
  ...
  describe '#automatic_review_mapping' do
    ...
    context 'when teams is not empty' do
      ...
      context 'when all nums in params are 0 except student_review_num' do
        it 'runs automatic review mapping strategy and redirects to review_mappings#list_mappings page' do
          allow_any_instance_of(ReviewMappingsController).to receive(:automatic_review_mapping_strategy).with(any_args).and_return(true)
          params = {
            id: 1,
            max_team_size: 1,
  ...
  describe '#start_self_review' do
    ...
    context 'when self review responses map does not exist' do
    ...
    context 'when self review responses map exists' do
