class GradesController < ApplicationController
  ...
  def view_my_scores
    ...
    @questions = retrieve_questions @assignment.questionnaires, @assignment.id # A hash containing all the questions in all the questionnaires used in this assignment
