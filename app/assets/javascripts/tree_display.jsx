        ...
        render: function() {
            ...
            if (this.state.showDetails) {
              ...
              <a title="Delete" href={"/tree_display/confirm?id="+(parseInt(this.props.id)/2).toString()+"&nodeType="+newNodeType}><img src="/assets/tree_view/delete-icon-24.png" /></a>
                ...
                if ( newNodeType === 'assignments' ){
                    moreContent.push(
                        <span>
            <a title="Copy" href={"/"+newNodeType+"/checktopicscopy?assets=course&id="+(parseInt(this.props.id)/2).toString()}><img src="/assets/tree_view/Copy-icon-24.png" /></a>
          </span>
                    )}
                else{
                    moreContent.push(
