describe GradesHelper, type: :helper do
  describe 'get_accordion_title' do
    it 'should render is_first:true if last_topic is nil' do
      ...
      expect(response).to render_template(partial: 'responses/_accordion', locals: {title: 'last question', is_first: true})
    end
    it 'should render is_first:false if last_topic is not equal to next_topic' do
      ...
      expect(response).to render_template(partial: 'responses/_accordion', locals: {title: 'next question', is_first: false})
    end
