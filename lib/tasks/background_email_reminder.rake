...
<<<<<<< HEAD
    ...
    puts "inside submission reminder"
    allParticipants = assign.participants
    #emails = Array.new
    ...
    for participant in allParticipants
     ...
     # puts "~~~~~~~~~~Sending submission_reminder if no submissions found ... submitted at nil #{(participant.submitted_at == nil)} .. hyperlink nil #{participant.submitted_hyperlink == nil} hyperlink empty #{participant.submitted_hyperlink != ""}\n"
      ...
      email_remind(emails, assign_name, due_date, assign_type, controller, action,id)
    end#end of for loop
    puts "~~~~~~~~~~Emails: #{emails.length} addresses, #{assign_name}, #{due_date.due_at}, #{assign_type}\n"
    #assign.participants.each do |assignment|
        #email_remind(emails, assign_name, due_date, assign_type, controller, action,allParticipants.id)
    #end
    ...
    for participant in allParticipants
      ...
      if(allresponsemaps.size > 0)
        for eachresponsemap in allresponsemaps
           puts "~~~~~~~~~~eachresponsemap.reviewee_id :#{eachresponsemap.reviewee_id}"
            ...
            #puts "responseeeeeeeeeeee    #{response.created_at}  response_id #{response.id}"
...
<<<<<<< HEAD
                ...
                puts "reviewwwwwwwwwww[0]::::: #{reviewee[0]}"
            ...
            email_remind(emails, assign_name, due_date, assign_type, controller, action, eachresponsemap.reviewer_id )
            puts "~~~~~~~~~~Emails: #{emails.length} addresses, #{assign_name}, #{due_date.due_at}, #{assign_type}\n"
...
<<<<<<< HEAD
  ...
  def email_remind(emails, assign_name, due_date, assign_type, controller, action, participantID)
...
<<<<<<< HEAD
        body = "This is a reminder to complete #{assign_type} for assignment #{assign_name}. Deadline is #{due_date_string}. You may submit/ review your work"
      end
