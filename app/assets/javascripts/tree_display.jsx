            ...
            if (this.state.showDetails) {
              ...
              <a title="Delete"
                ...
                moreContent.push(
                    <span>
            <a title="Copy"
               href={"/" + newNodeType + "/copy?assets=course&id=" + (parseInt(this.props.id) / 2).toString()}><img
                src="/assets/tree_view/Copy-icon-24.png"/></a>
          </span>
                )
                if (newNodeType === 'course') {
                    ...
                    if (this.props.is_available) {
                        moreContent.push(
                            <span>
                <a title="Add TA"
                   href={"/course/view_teaching_assistants?id=" + (parseInt(this.props.id) / 2).toString() + "&model=Course"}>
                  <img src="/assets/tree_view/add-ta-24.png"/>
                </a>
                <a title="Create assignment"
                   href={"/assignments/new?parent_id=" + (parseInt(this.props.id) / 2).toString()}>
                  <img src="/assets/tree_view/add-assignment-24.png"/>
                </a>
                <a title="Add participants"
                   href={"/participants/list?id=" + (parseInt(this.props.id) / 2).toString() + "&model=Course"}>
                  <img src="/assets/tree_view/add-participant-24.png"/>
                </a>
                <a title="Create teams"
                   href={"/teams/list?id=" + (parseInt(this.props.id) / 2).toString() + "&type=Course"}>
                  <img src="/assets/tree_view/create-teams-24.png"/>
                </a>
                <a title="360 degree assessment dashboad"
                   href={"/assessment360/one_course_all_assignments?course_id=" + (parseInt(this.props.id) / 2).toString()}>
                  <img src="/assets/tree_view/360-dashboard-24.png"/>
                </a>
                <a title="Assign survey"
                   href={"/survey_deployment/new?id=" + (parseInt(this.props.id) / 2).toString() + "&type=CourseSurveyDeployment"}>
                  <img src="/assets/tree_view/assign-survey-24.png"/>
                </a>
                <a title="View aggregated teammate & meta reviews"
                   href={"/assessment360/all_students_all_reviews?course_id=" + (parseInt(this.props.id) / 2).toString()}>
                  <span style={{"fontSize": "22px", "top": "8px"}} className="glyphicon glyphicon-list-alt"></span>
                    ...
                    if (this.props.course_id) {
                        moreContent.push(
                            <span>
                <a title="Remove from course"
                   href={"/assignments/remove_assignment_from_course?id=" + (parseInt(this.props.id) / 2).toString()}>
                  <img src="/assets/tree_view/remove-from-course-24.png"/>
                        ...
                        moreContent.push(
                            <span>
                <a title="Assign to course"
                   href={"/assignments/associate_assignment_with_course?id=" + (parseInt(this.props.id) / 2).toString()}>
                ...
                <a title="View review report"
                   href={"/review_mapping/response_report?id=" + (parseInt(this.props.id) / 2).toString()}>
                  <img src="/assets/tree_view/view-review-report-24.png"/>
                </a>
              <a title="View survey responses"
            ...
            if (this.props.dataType == 'course') {
                ...
                return (
                    <tr onClick={this.handleClick} id={this.props.id}>
                        <td width={colWidthArray[0]}>{this.props.name}</td>
                        <td style={colDisplayStyle} width={colWidthArray[3]}>{institution_name}</td>
                        <td style={colDisplayStyle} width={colWidthArray[4]}
                            dangerouslySetInnerHTML={{__html: creation_date}}></td>
                        <td style={colDisplayStyle} width={colWidthArray[5]}
                            dangerouslySetInnerHTML={{__html: updated_date}}></td>
                        <td width={colWidthArray[6]}>
                            <RowAction
                                actions={this.props.actions}
                                key={this.props.id}
            ...
            return (
                ...
                >
                    ...
                    <ReactSimpleTabs.Panel title="Questionnaires">
                        <FilterableTable key="table2" dataType='questionnaire'
