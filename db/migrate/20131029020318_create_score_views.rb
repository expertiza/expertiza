class CreateScoreViews < ActiveRecord::Migration
    ...
    def self.up
      execute <<-SQL
      CREATE VIEW scoreViews AS SELECT ques.weight question_weight,q.id AS q_id,q.q_type AS q_type,q.parameters AS q_parameters,q.question_id AS q_question_id,
