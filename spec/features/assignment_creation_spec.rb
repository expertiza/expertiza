...
describe "assignment function" do
  ...
  it "should show error message for name" do
    login_as("instructor6")
    visit "/assignments/new?private=0"

    fill_in 'assignment_form_assignment_name', with: ' '
    click_button 'Create'
  ...
  it "should show error message for directory" do
    ...
    click_button 'Create'
    page.should_have_content "Directory cannot be empty! and no special characters are allowed. Please check the format"
  end
...
it "should not create with empty name" do
  ...
  expect(!assignment.save).to raise_exception(/Name cannot be empty nor contain special characters/)
end

it "should not create with empty subdirectory" do
  login_as("instructor6")
  visit "/assignments/new?private=1"
  ...
  click_button 'Create'
  assignment = Assignment.where(name: 'private assignment for test').first
  expect(!assignment.save).to raise_exception(/Directory cannot be empty nor contain special characters/)
end
