module ReviewMappingsHelper
  ...
  #
  # gets the responses map data such as reviewer id, reviewd object id and type for the review report
  #
  ...
  def get_each_review_and_feedback_response_map(author)
    ...
    {1 => 'one', 2 => 'two', 3 => 'three'}.each do |key, round_num|
      ...
      # Calculate feedback responses map records
  ...
  #returns true if the review responses's visibility is public or published else returns false. (Visibility public or published means student
