class CreateTeamsParticipants < ActiveRecord::Migration[4.2]
  def self.up
    ...
    add_index 'teams_participants', ['user_id'], name: 'fk_teams_participants'

    execute "alter table teams_participants
               add constraint fk_teams_participants
