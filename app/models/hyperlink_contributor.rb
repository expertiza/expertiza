      ...
      hyperlinks.each do |hyperlink|
        ...
        begin
          ...
          if !new_ts.nil? && new_ts > old_ts
            old_team_id = last_update_ev.nil? ? "0" : last_update_ev.team_id
            old_assignment_id = last_update_ev.nil? ? "0" : last_update_ev.assignment_id
            SubmissionHistory.create_new_hyperlink_update_event(contributor.participant_id,
                                                                old_team_id, old_assignment_id,
                                                                hyperlink, new_ts)
          end
        rescue
