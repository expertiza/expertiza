describe ReputationWebServiceController do
  ...
  describe 'custom test' do
    before(:each) do
      ...
      @itemnaire_1 = create(:itemnaire, min_item_score: 0, max_item_score: 5, type: 'ReviewQuestionnaire', id: 1)
      # assignment_itemnaire_<i>_<j> means assignment #i's #j th round of review.
      @assignment_itemnaire_1_1 = create(:assignment_itemnaire, assignment_id: @assignment_1.id, itemnaire_id: @itemnaire_1.id, used_in_round: 1)
      @assignment_itemnaire_1_2 = create(:assignment_itemnaire, assignment_id: @assignment_1.id, itemnaire_id: @itemnaire_1.id, used_in_round: 2)
      @assignment_itemnaire_2_1 = create(:assignment_itemnaire, assignment_id: @assignment_2.id, itemnaire_id: @itemnaire_1.id, used_in_round: 1)
      @assignment_itemnaire_2_2 = create(:assignment_itemnaire, assignment_id: @assignment_2.id, itemnaire_id: @itemnaire_1.id, used_in_round: 2, id: 4)

      # item_i_j means item #j in itemnaire #i.
      @item_1_1 = create(:item, itemnaire_id: @itemnaire_1.id, id: 1)
      @item_1_2 = create(:item, itemnaire_id: @itemnaire_1.id, id: 2)
      @item_1_3 = create(:item, itemnaire_id: @itemnaire_1.id, id: 3)
      @item_1_4 = create(:item, itemnaire_id: @itemnaire_1.id, id: 4)
      @item_1_5 = create(:item, itemnaire_id: @itemnaire_1.id, id: 5)
    ...
    context 'test db_query' do
      it 'return average score' do
        ...
        # create 5 answers for 5 related items
        create(:answer, item_id: @item_1_1.id, response_id: @response_1_1.id, answer: 1)
        create(:answer, item_id: @item_1_2.id, response_id: @response_1_1.id, answer: 2)
        create(:answer, item_id: @item_1_3.id, response_id: @response_1_1.id, answer: 3)
        create(:answer, item_id: @item_1_4.id, response_id: @response_1_1.id, answer: 4)
        create(:answer, item_id: @item_1_5.id, response_id: @response_1_1.id, answer: 5)
    ...
    context 'test json_generator' do
      it 'test 3 reviewer for one reviewee' do
        ...
        create(:answer, item_id: @item_1_1.id, response_id: @response_1_1.id, answer: 5)
        create(:answer, item_id: @item_1_2.id, response_id: @response_1_1.id, answer: 5)
        create(:answer, item_id: @item_1_3.id, response_id: @response_1_1.id, answer: 5)
        create(:answer, item_id: @item_1_4.id, response_id: @response_1_1.id, answer: 5)
        create(:answer, item_id: @item_1_5.id, response_id: @response_1_1.id, answer: 5)

        # reivewer_2's review for reviewee_1; Numeric value of the answer array
        # for response_1_2: [3, 3, 3, 3, 3]
        create(:answer, item_id: @item_1_1.id, response_id: @response_1_2.id, answer: 3)
        create(:answer, item_id: @item_1_2.id, response_id: @response_1_2.id, answer: 3)
        create(:answer, item_id: @item_1_3.id, response_id: @response_1_2.id, answer: 3)
        create(:answer, item_id: @item_1_4.id, response_id: @response_1_2.id, answer: 3)
        create(:answer, item_id: @item_1_5.id, response_id: @response_1_2.id, answer: 3)

        # reivewer_3's review for reviewee_1; Numeric value of the answer array
        # for response_1_3: [1, 1, 1, 1, 1]
        create(:answer, item_id: @item_1_1.id, response_id: @response_1_3.id, answer: 1)
        create(:answer, item_id: @item_1_2.id, response_id: @response_1_3.id, answer: 1)
        create(:answer, item_id: @item_1_3.id, response_id: @response_1_3.id, answer: 1)
        create(:answer, item_id: @item_1_4.id, response_id: @response_1_3.id, answer: 1)
        create(:answer, item_id: @item_1_5.id, response_id: @response_1_3.id, answer: 1)
      ...
      it 'test same reviewer for different reviewee' do
        ...
        create(:answer, item_id: @item_1_1.id, response_id: @response_2_1.id, answer: 3)
        create(:answer, item_id: @item_1_2.id, response_id: @response_2_1.id, answer: 3)
        create(:answer, item_id: @item_1_3.id, response_id: @response_2_1.id, answer: 3)
        create(:answer, item_id: @item_1_4.id, response_id: @response_2_1.id, answer: 3)
        create(:answer, item_id: @item_1_5.id, response_id: @response_2_1.id, answer: 3)
