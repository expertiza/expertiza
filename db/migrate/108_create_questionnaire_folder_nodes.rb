class CreateQuestionnaireFolderNodes < ActiveRecord::Migration
  def self.up
    ...
    fnode = TreeFolder.create(:name => 'Review', :child_type => 'QuestionnaireNode', :parent_id => parent.id)
    ...
    fnode = TreeFolder.create(:name => 'Metareview', :child_type => 'QuestionnaireNode', :parent_id => parent.id)
    pfNode = FolderNode.create(:parent_id => pNode.id, :node_object_id => fnode.id)
    ...
    fnode = TreeFolder.create(:name => 'Author Feedback', :child_type => 'QuestionnaireNode', :parent_id => parent.id)
    pfNode = FolderNode.create(:parent_id => pNode.id, :node_object_id => fnode.id)
    ...
    fnode = TreeFolder.create(:name => 'Teammate Review', :child_type => 'QuestionnaireNode', :parent_id => parent.id)
    pfNode = FolderNode.create(:parent_id => pNode.id, :node_object_id => fnode.id)
    ...
    fnode = TreeFolder.create(:name => 'Survey', :child_type => 'QuestionnaireNode', :parent_id => parent.id)
    pfNode = FolderNode.create(:parent_id => pNode.id, :node_object_id => fnode.id)
    ...
    fnode = TreeFolder.create(:name => 'Global Survey', :child_type => 'QuestionnaireNode', :parent_id => parent.id)
    pfNode = FolderNode.create(:parent_id => pNode.id, :node_object_id => fnode.id)
    ...
    fnode = TreeFolder.create(:name => 'Course Evaluation', :child_type => 'QuestionnaireNode', :parent_id => parent.id)
    pfNode = FolderNode.create(:parent_id => pNode.id, :node_object_id => fnode.id)
  ...
  def self.down
    drop_table :questionnaire_folder_nodes
  end
end
