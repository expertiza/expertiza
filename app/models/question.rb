class Question < ActiveRecord::Base
  ...
  belongs_to :team, class_name: 'AssignmentTeam', foreign_key: 'team_id' #E2016: each question may belong to a specific assignment team
  ...
  validates :team_id, numericality: true, allow_nil: true #E2016: team_id must be numeric
