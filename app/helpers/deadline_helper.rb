...
module DeadlineHelper
  ...
  def self.set_start_due_date(assignment_id, set_of_topics)
    ...
    set_of_topics.each do |set_of_topic|
      ...
      if i == 0
        ...
        set_of_due_dates.sort_by(&:due_at)

        offset = days_between_submissions
      end

      set_of_topic.each do |topic_id|
        ...
        unless prev_saved_due_dates.nil?
        ...
        set_of_due_dates.each_with_index do |due_date, _index|
