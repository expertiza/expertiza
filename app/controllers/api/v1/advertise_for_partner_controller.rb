module Api::V1
  class AdvertiseForPartnerController < BasicApiController
    def action_allowed?
    ...
    def update
      begin
        ...
        participant = AssignmentParticipant.find_by(parent_id: @team.assignment.id, user_id: current_user.id)
        ...
        render json: {status: :ok, error: 'An error occurred and your advertisement was not updated!'}
      else
        ...
        # redirect_to view_student_teams_path student_id: participant.id
        render json: {status: :ok, message: 'Your advertisement was successfully updated!'}
      end
    end
    ...
    def getAdContent
      ...
      render json: {status: :ok , ad_content: ad_content}
    end
  end
end