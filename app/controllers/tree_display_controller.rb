class TreeDisplayController < ApplicationController
  ...
  def list
    ...
    redirect_to controller: :student_task, action: :list_topics if current_user.try(:student?)
  end

  def confirm_notifications_access
    redirect_to controller: :notifications, action: :list_topics if current_user.try(:student?)
  end
