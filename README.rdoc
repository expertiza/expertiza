...
The Website link for our team's work is: 
...
10. Eliminat the search for reviews and meta reviews during the grades_show method.
...
Instructor: 
Login -> Assignments->Program 2 style ->view scores. 
Student:
