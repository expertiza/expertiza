...
RSpec.describe ReviewMappingHelper, :type => :helper do
  describe "test css_style_for_calibration_report" do
    it "should return correct css for calibration report" do
      expect(helper.css_style_for_calibration_report(1)).to eq('c4')
      expect(helper.css_style_for_calibration_report(0)).to eq('c5')
      expect(helper.css_style_for_calibration_report(2)).to eq('c3')
      expect(helper.css_style_for_calibration_report(3)).to eq('c2')
      expect(helper.css_style_for_calibration_report(4)).to eq('c1')
    end
  end
end
