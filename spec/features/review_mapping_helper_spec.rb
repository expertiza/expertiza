...
RSpec.describe ReviewMappingHelper, type: :helper do
  describe 'test calibration_report_css_class' do
    it 'should return correct css for calibration report' do
      expect(helper.calibration_report_css_class(1)).to eq('c4')
      expect(helper.calibration_report_css_class(0)).to eq('c5')
      expect(helper.calibration_report_css_class(2)).to eq('c3')
      expect(helper.calibration_report_css_class(3)).to eq('c2')
      expect(helper.calibration_report_css_class(4)).to eq('c1')
    end
  end
end
