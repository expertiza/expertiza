...
ActiveRecord::Schema.define(:version => 20110512155258) do
  ...
  create_table "assignments", :force => true do |t|
    ...
    t.integer  "num_metareviews",                  :default => 0,     :null => false
    t.integer  "num_metareviewers",                :default => 0,     :null => false
    t.integer  "review_questionnaire_id"
    t.integer  "metareview_questionnaire_id"
  ...
  create_table "due_dates", :force => true do |t|
    ...
    t.integer  "metareview_allowed_id"
