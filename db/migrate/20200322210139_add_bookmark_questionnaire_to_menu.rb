class AddBookmarkQuestionnaireToMenu < ActiveRecord::Migration
    ...
    MenuItem.find_or_create_by(:name => 'manage/questionnaires/bookmark reviews', :label => 'Bookmark Rating rubrics', :parent_id => item.id, :seq => maxseq+1, :controller_action_id => bookmarkreview_rubrics_action.id)
