...
ActiveRecord::Schema.define(version: 20200422231833) do
  ...
  create_table "mentor_review_questionnaires", force: :cascade do |t|
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  end

  create_table "mentor_review_response_maps", force: :cascade do |t|
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  end
