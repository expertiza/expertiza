...
ActiveRecord::Schema.define(version: 20171126235746) do
  ...
  add_index "awarded_badges", ["assignment_id"], name: "index_awarded_badges_on_assignment_id", using: :btree
  ...
  add_foreign_key "awarded_badges", "assignments"
