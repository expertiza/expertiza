...
=======
      expect(html).to eq("<tr><td align=\"center\"><a rel=\"nofollow\" data-method=\"delete\" href=\"/questions/1\">Remove</a></td><td><input size=\"6\" value=\"1.0\" name=\"question[1][seq]\" id=\"question_1_seq\" type=\"text\"></td><td><textarea cols=\"50\" rows=\"1\" name=\"question[1][txt]\" id=\"question_1_txt\" placeholder=\"Edit question content here\">test txt</textarea></td><td><input size=\"10\" disabled=\"disabled\" value=\"Scale\" name=\"question[1][type]\" id=\"question_1_type\" type=\"text\"></td><td><input size=\"2\" value=\"1\" name=\"question[1][weight]\" id=\"question_1_weight\" type=\"text\"></td><td style=\"color: grey\">N/A</td><td> min_label <input size=\"10\" value=\"\" name=\"question[1][min_label]\" id=\"question_1_min_label\" type=\"text\">  max_label <input size=\"12\" value=\"\" name=\"question[1][max_label]\" id=\"question_1_max_label\" type=\"text\"></td></tr>")
>>>>>>> master
    end
  end
