...
def update_assignments_duties(attributes)
 ...
 def update_assignment_duty_questionnaires(attributes)
  return false unless attributes
  attributes.each do |key,val|
    if val != "" then
     @assignment_duty_map = AssignmentDutyQuestionnaireMapping.new(assignment_id: @assignment.id, duty_id: val.to_i)
