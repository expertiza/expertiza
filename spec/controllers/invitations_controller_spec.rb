describe InvitationsController do
  ...
  let(:assignment) { build(:assignment, id: 2, is_assignment_conference: 1, max_team_size:100) }
  let(:assignment2) { build(:assignment, id: 2, is_assignment_conference: 0, max_team_size:100) }
