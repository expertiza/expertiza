  ...
  class Summary
    ...
    def summarize_reviews_by_criterion(assignment, summary_ws_url)
      ...
      for round in 0..nround-1
        ...
        self.summary[round] = Hash.new
        self.avg_scores_by_criterion[round] = Hash.new
    ...
    def summarize_reviews_by_reviewees(assignment, summary_ws_url)
      ...
      teams.each do |reviewee|
        self.summary[reviewee.name] = Array.new
        self.avg_scores_by_reviewee[reviewee.name] = 0.0
        self.avg_scores_by_round[reviewee.name]= Array.new
        self.avg_scores_by_criterion[reviewee.name]= Array.new
        ...
        for round in 0..assignment.rounds_of_reviews-1
          self.summary[reviewee.name][round] = Hash.new
          self.avg_scores_by_round[reviewee.name][round] = 0.0
          self.avg_scores_by_criterion[reviewee.name][round]=Hash.new
          ...
          rubric_used.each do |q|
            ...
            Thread.new do
              summary[reviewee.name][round][q.txt] = summarize_sentences(comments, summary_ws_url) if comments.size > 0
            end
