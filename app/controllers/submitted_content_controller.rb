class SubmittedContentController < ApplicationController
  ...
  def submit_hyperlink
    ...
    if team_hyperlinks.include?(params['submission'])
      ExpertizaLogger.error LogMessage.new(controller_name, @participant.name, 'You or your teammate(s) have already submitted the same hyperlink.', request)
      ...
      begin
        ...
        ExpertizaLogger.error LogMessage.new(controller_name, @participant.name, "The URL or URI is invalid. Reason: #{$ERROR_INFO}", request)
        flash[:error] = "The URL or URI is invalid. Reason: #{$ERROR_INFO}"
      end
      ExpertizaLogger.info LogMessage.new(controller_name, @participant.name, 'The link has been successfully submitted.', request)
  ...
  def remove_hyperlink
    ...
    ExpertizaLogger.info LogMessage.new(controller_name, @participant.name, 'The link has been successfully removed.', request)
  ...
  def submit_file
    ...
    ExpertizaLogger.info LogMessage.new(controller_name, @participant.name, 'The file has been submitted.', request)
  ...
  def delete_selected_files
    ...
    ExpertizaLogger.info LogMessage.new(controller_name, @participant.name, 'The selected file has been deleted.', request)
  end
