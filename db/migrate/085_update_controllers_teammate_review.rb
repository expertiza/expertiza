class UpdateControllersTeammateReview < ActiveRecord::Migration[4.2][4.2]
  def self.up
    ...
    teammate_review_action = ControllerAction.find_or_create_by(name: 'goto_teammate_reviews')
