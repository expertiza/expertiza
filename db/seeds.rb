...
SiteController.create(:name => 'lottery', :builtin => false, :permission_id => Permission.find_by_name('administer assignments').id)
...
ControllerAction.create(:site_controller_id => SiteController.find_by_name('lottery').id, :name => 'run_lottery', :permission_id => Permission.find_by_name('administer assignments').id, :url_to_use => '')
...
AssignmentParticipant.create!(:user_id => student.id,
                              ...
                              :handle => 'student',
                              :permission_granted => 1)
CourseParticipant.create!(:user_id => student2.id,
                          :parent_id => assignment.id,
                          :handle => 'student2',
                          :permission_granted => 1)
AssignmentParticipant.create!(:user_id => student2.id,
                              :parent_id => assignment.id,
                              :handle => 'student2',
                              :permission_granted => 1)
