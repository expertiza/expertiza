...
class Assignment < ApplicationRecord
  ...
  def self.copy_calibrated_reviews(old_assignment, new_assignment_id)
    if old_assignment.is_calibrated
      ...
      teams_mapping = AssignmentTeam.copy_teams_for_assignment(old_assignment.id, new_assignment_id)
      participants_mapping = AssignmentParticipant.copy_participants_for_assignment(old_assignment.id, new_assignment_id)
