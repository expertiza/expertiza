class InstitutionsController < ApplicationController
  ...
  def create
    ...
    if @institution.save
      flash[:success] = 'The institutions was successfully created.'
      redirect_to action: 'list'
    else
      flash[:error] = 'The creation of the institutions failed.'
      render action: 'new'
    end
  end
  ...
  def update
    ...
    if @institution.update_attribute(:name, params[:institution][:name])
      ...
      flash[:success] = 'The institutions was successfully updated.'
      redirect_to action: 'list'
    else
      render action: 'edit'
    end
