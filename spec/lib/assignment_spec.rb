...
describe Assignment do 
  ...
  it "should raise 'Path cannot be created...' Error if course_id and instructor_id are nil" do 
    ...
    expect{assignment.get_path}.to raise_error('Path cannot be created. The assignment must be associated with either a course or an instructor.')
  end
  ...
  it "should raise PathError if wiki_type is not 1" do 
    ...
    expect{assignment.get_path}.to raise_error(PathError)
  end
