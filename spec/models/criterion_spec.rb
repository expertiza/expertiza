...
describe "criterion" do
  ...
  describe "#edit" do
    it "returns the html " do
      ...
      expect(html).to eq("<tr><td align=\"center\"><a rel=\"nofollow\" data-method=\"delete\" href=\"/questions/1\">Remove</a></td><td><input size=\"6\" value=\"1.0\" name=\"question[1][seq]\" id=\"question_1_seq\" type=\"text\"></td><td><textarea cols=\"50\" rows=\"1\" name=\"question[1][txt]\" id=\"question_1_txt\">test txt</textarea></td><td><input size=\"10\" disabled=\"disabled\" value=\"Criterion\" name=\"question[1][type]\" id=\"question_1_type\" type=\"text\"></td><td><input size=\"2\" value=\"1\" name=\"question[1][weight]\" id=\"question_1_weight\" type=\"text\"></td><td>text area size <input size=\"3\" value=\"\" name=\"question[1][size]\" id=\"question_1_size\" type=\"text\"></td><td> max_label <input size=\"10\" value=\"\" name=\"question[1][max_label]\" id=\"question_1_max_label\" type=\"text\">  min_label <input size=\"10\" value=\"\" name=\"question[1][min_label]\" id=\"question_1_min_label\" type=\"text\"></td></tr>")
    end
  end
  ...
  describe "#view_completed_question" do
    it "returns the html " do
      ...
      expect(html).to eq( "<big><b>Question 0:</b> <I>test txt</I></big><BR/><TABLE CELLPADDING=\"5\"><TR><TD valign=\"top\"><B>Score: </B></TD><TD><FONT style=\"BACKGROUND-COLOR:gold\">8</FONT> out of <B>5</B></TD></TR></TD></TR></TABLE><BR/>")
    end
  end
