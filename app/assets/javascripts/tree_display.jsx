jQuery(document).ready(function () {
    ...
    var RowAction = React.createClass({
        ...
        render: function () {
            ...
            <a title="Copy" href={"/" + newNodeType + "/copy?assets=course&id=" + (parseInt(this.props.id) / 2).toString()}><img src="/assets/tree_view/Copy-icon-24.png" /></a>
                ...
                <a title="View review report" href={"/reports/response_report?id=" + (parseInt(this.props.id) / 2).toString()}>
        ...
        render: function () {
            return (
                <div>
                    ...
                    {this.state.advancedSearchVisible ? <AssignmentAdvancedSearchBar ref={instance => { this.child = instance; }} /> : null}
                </div>
            );
        }
    })
    ...
    var FilterableTable = React.createClass({
        ...
        handleSearchClick: function (search) {
    ...
    var TabSystem = React.createClass({
        ...
        componentWillMount: function () {
            ...
            this.loadTableData(this.state.search)
        },
