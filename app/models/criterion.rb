...
class Criterion < ScoredQuestion
  ...
  def edit(_count)
    ...
    html += '<td> min_label <input size="12" value="' + min_label.to_s + '" name="question[' + id.to_s
    html += '][min_label]" id="question_' + id.to_s + '_min_label" type="text">  max_label <input size="10" value="' + max_label.to_s
    html += '" name="question[' + id.to_s + '][max_label]" id="question_' + id.to_s + '_max_label" type="text"></td>'
