...
class VmQuestionResponseRow
  def initialize(questionText, question_id, weight, question_max_score, seq, default_score = []) # Added default_score variable as a parameter to constructor to enhance the code dymnamically.
