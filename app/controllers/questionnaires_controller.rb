class QuestionnairesController < ApplicationController
  ...
  def update
    ...
    if params[:add_new_questions]
      ...
      redirect_to action: 'add_new_ScoredQuestion', id: permitted_params[:id], question: permitted_params[:new_question]
  ...
  def add_new_questions
    ...
    num_questions = Questionnaire.find(questionnaire_id).questions.size
    ((num_questions + 1)..(num_questions + params[:question][:total_num].to_i)).each do |i|
