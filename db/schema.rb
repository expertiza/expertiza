...
ActiveRecord::Schema.define(version: 20220111023859) do
  ...
  create_table "account_requests", id: :integer, auto_increment: true, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1" do |t|
    t.string "name"
    t.integer "role_id"
    t.string "fullname"
  ...
  create_table "answer_tags", id: :integer, auto_increment: true, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1" do |t|
    t.integer "answer_id"
  ...
  create_table "answers", id: :integer, auto_increment: true, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1" do |t|
  ...
  create_table "assignment_badges", id: :integer, auto_increment: true, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1" do |t|
    t.integer "badge_id"
  ...
  create_table "assignment_questionnaires", id: :integer, auto_increment: true, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1" do |t|
    t.integer "assignment_id"
  ...
  create_table "assignments", id: :integer, auto_increment: true, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1" do |t|
  ...
  create_table "automated_metareviews", id: :integer, auto_increment: true, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1" do |t|
  ...
  create_table "awarded_badges", id: :integer, auto_increment: true, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1" do |t|
    t.integer "badge_id"
  ...
  create_table "badges", id: :integer, auto_increment: true, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1" do |t|
    t.string "name"
  ...
  create_table "bids", id: :integer, auto_increment: true, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1" do |t|
    t.integer "topic_id"
    t.integer "team_id"
    t.datetime "created_at"
    t.datetime "updated_at"
  ...
  create_table "bookmark_ratings", id: :integer, auto_increment: true, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1" do |t|
  ...
  create_table "bookmarks", id: :integer, auto_increment: true, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1" do |t|
    t.text "url"
    t.text "title"
    t.text "description"
    t.integer "user_id"
  ...
  create_table "calculated_penalties", id: :integer, auto_increment: true, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1" do |t|
    t.integer "participant_id"
    t.integer "deadline_type_id"
    t.integer "penalty_points"
  end

  create_table "content_pages", id: :integer, auto_increment: true, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1" do |t|
    t.string "title"
  ...
  create_table "controller_actions", id: :integer, auto_increment: true, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1" do |t|
  ...
  create_table "courses", id: :integer, auto_increment: true, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1" do |t|
    t.string "name"
  ...
  create_table "deadline_rights", id: :integer, auto_increment: true, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1" do |t|
    t.string "name", limit: 32
  end

  create_table "deadline_types", id: :integer, auto_increment: true, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1" do |t|
    t.string "name", limit: 32
  end

  create_table "delayed_jobs", id: :integer, auto_increment: true, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1" do |t|
  ...
  create_table "due_dates", id: :integer, auto_increment: true, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1" do |t|
    t.datetime "due_at"
    t.integer "deadline_type_id"
    t.integer "parent_id"
  ...
  create_table "duties", id: :integer, auto_increment: true, default: nil, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1" do |t|
    t.string "name"
  ...
  create_table "institutions", id: :integer, auto_increment: true, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1" do |t|
    t.string "name", default: "", null: false
  end

  create_table "invitations", id: :integer, auto_increment: true, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1" do |t|
    t.integer "assignment_id"
    t.integer "from_id"
    t.integer "to_id"
  ...
  create_table "join_team_requests", id: :integer, auto_increment: true, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1" do |t|
    t.integer "participant_id"
    t.integer "team_id"
    t.text "comments"
  ...
  create_table "languages", id: :integer, auto_increment: true, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1" do |t|
    t.string "name", limit: 32
  end

  create_table "late_policies", id: :integer, auto_increment: true, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1" do |t|
  ...
  create_table "locks", id: :integer, auto_increment: true, default: nil, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1" do |t|
  ...
  create_table "markup_styles", id: :integer, auto_increment: true, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1" do |t|
    t.string "name", default: "", null: false
  end

  create_table "menu_items", id: :integer, auto_increment: true, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1" do |t|
    t.integer "parent_id"
    t.string "name", default: "", null: false
  ...
  create_table "nodes", id: :integer, auto_increment: true, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1" do |t|
    t.integer "parent_id"
    t.integer "node_object_id"
    t.string "type"
  end

  create_table "notifications", id: :integer, auto_increment: true, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.string "subject"
    t.text "description"
  ...
  create_table "participants", id: :integer, auto_increment: true, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1" do |t|
  ...
  create_table "password_resets", id: :integer, auto_increment: true, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.string "user_email"
    t.string "token"
    t.datetime "updated_at"
  end

  create_table "permissions", id: :integer, auto_increment: true, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1" do |t|
    t.string "name", default: "", null: false
  end

  create_table "plagiarism_checker_assignment_submissions", id: :integer, auto_increment: true, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.string "name"
  ...
  create_table "plagiarism_checker_comparisons", id: :integer, auto_increment: true, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
  ...
  create_table "question_advices", id: :integer, auto_increment: true, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1" do |t|
  ...
  create_table "questionnaires", id: :integer, auto_increment: true, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1" do |t|
  ...
  create_table "questions", id: :integer, auto_increment: true, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1" do |t|
    t.text "txt"
    t.integer "weight"
    t.integer "questionnaire_id"
  ...
  create_table "quiz_question_choices", id: :integer, auto_increment: true, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1" do |t|
    t.integer "question_id"
    t.text "txt"
    t.boolean "iscorrect", default: false
  end

  create_table "response_maps", id: :integer, auto_increment: true, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1" do |t|
  ...
  create_table "responses", id: :integer, auto_increment: true, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1" do |t|
  ...
  create_table "resubmission_times", id: :integer, auto_increment: true, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1" do |t|
    t.integer "participant_id"
    t.datetime "resubmitted_at"
    t.index ["participant_id"], name: "fk_resubmission_times_participants"
  end

  create_table "review_bids", id: :integer, auto_increment: true, default: nil, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1" do |t|
    t.integer "priority"
  ...
  create_table "review_comment_paste_bins", id: :integer, auto_increment: true, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
  ...
  create_table "review_grades", id: :integer, auto_increment: true, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.integer "participant_id"
  ...
  create_table "roles", id: :integer, auto_increment: true, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1" do |t|
    t.string "name", default: "", null: false
    t.integer "parent_id"
  ...
  create_table "roles_permissions", id: :integer, auto_increment: true, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1" do |t|
  ...
  create_table "sample_reviews", id: :integer, auto_increment: true, default: nil, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1" do |t|
    t.integer "assignment_id"
    t.integer "response_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  create_table "sections", id: :integer, auto_increment: true, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci" do |t|
  ...
  create_table "sessions", id: :integer, auto_increment: true, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1" do |t|
  ...
  create_table "sign_up_topics", id: :integer, auto_increment: true, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1" do |t|
  ...
  create_table "signed_up_teams", id: :integer, auto_increment: true, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1" do |t|
  ...
  create_table "site_controllers", id: :integer, auto_increment: true, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1" do |t|
    t.string "name", default: "", null: false
    t.integer "permission_id", default: 0, null: false
  ...
  create_table "submission_records", id: :integer, auto_increment: true, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1" do |t|
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.text "type"
    t.string "content"
  ...
  create_table "suggestion_comments", id: :integer, auto_increment: true, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1" do |t|
    t.text "comments"
    t.string "commenter"
    t.string "vote"
  ...
  create_table "suggestions", id: :integer, auto_increment: true, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1" do |t|
    t.integer "assignment_id"
    t.string "title"
    t.text "description"
    t.string "status"
  ...
  create_table "survey_deployments", id: :integer, auto_increment: true, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1" do |t|
    t.integer "questionnaire_id"
  ...
  create_table "system_settings", id: :integer, auto_increment: true, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1" do |t|
  ...
  create_table "ta_mappings", id: :integer, auto_increment: true, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1" do |t|
    t.integer "ta_id"
    t.integer "course_id"
  ...
  create_table "tag_prompt_deployments", id: :integer, auto_increment: true, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1" do |t|
  ...
  create_table "tag_prompts", id: :integer, auto_increment: true, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1" do |t|
    t.string "prompt"
    t.string "desc"
  ...
  create_table "teams", id: :integer, auto_increment: true, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1" do |t|
    t.string "name"
    t.integer "parent_id"
    t.string "type"
  ...
  create_table "teams_users", id: :integer, auto_increment: true, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1" do |t|
    t.integer "team_id"
    t.integer "user_id"
    t.integer "duty_id"
  ...
  create_table "track_notifications", id: :integer, auto_increment: true, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1" do |t|
  ...
  create_table "tree_folders", id: :integer, auto_increment: true, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1" do |t|
    t.string "name"
    t.string "child_type"
    t.integer "parent_id"
  end

  create_table "user_pastebins", id: :integer, auto_increment: true, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.integer "user_id"
    t.string "short_form"
    t.text "long_form"
    t.datetime "created_at", null: false
  ...
  create_table "users", id: :integer, auto_increment: true, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.string "name", default: "", null: false
  ...
  create_table "versions", id: :integer, auto_increment: true, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
