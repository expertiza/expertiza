Expertiza::Application.configure do
  ...
  config.assets.precompile = %w( application-*.js assignment_rubrics.js assignment_due_dates.js assignment_general.js assignment_review_strategy.js edit_assignments.js)
