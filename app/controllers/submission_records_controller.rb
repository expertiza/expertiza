class SubmissionRecordsController < ApplicationController
  ...
  def action_allowed?
    ...
    user_participant=assignment_team.participant(current_user)
    ...
    return true if Participant.get_authorization(user_participant.can_submit,user_participant.can_review,user_participant.can_take_quiz)=='mentor'
    false
  end
