class UpdateForImpersonation < ActiveRecord::Migration
  def self.up
    permission1 = Permission.find_by_name('administer courses');
    ...
    ControllerAction.create(:name => 'restore', :site_controller_id => site_controller.id, :permission_id => permission2.id)
