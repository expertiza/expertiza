...
class MeetingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create meeting" do
    assert_difference('Meeting.count') do
      post meetings_url, params: { meeting: { Date: @meeting.Date, TeamID: @meeting.TeamID } }
    end
  ...
  test "should update meeting" do
    patch meeting_url(@meeting), params: { meeting: { Date: @meeting.Date, TeamID: @meeting.TeamID } }
