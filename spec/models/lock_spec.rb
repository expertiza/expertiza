...
describe Lock do
  ...
  before(:each) do
    ...
    @smyoder = User.new(username: 'smyoder', fullname: 'John Bumgardner', email: 'smyoder@ncsu.edu')
    @smyoder.save!

    @smyoder1 = User.new(username: 'smyoder1', fullname: 'John Bumgardner', email: 'smyoder1@ncsu.edu')
    @smyoder1.save!
