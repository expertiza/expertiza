describe Duty do
  ...
  let(:user2) { build(:student, id: 2, username: 'no name2', fullname: 'no one2', participants: [participant2]) }
  let(:user3) { build(:student, id: 3, username: 'no name3', fullname: 'no one3', participants: [participant3]) }
