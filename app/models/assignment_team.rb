class AssignmentTeam < Team
  ...
  attr_accessible :name, :parent_id, :type, :name, :directory_path, :require_quiz, :course_id, :max_team_size, :review_assignment_strategy, :review_topic_threshold, :max_reviews_per_submission
